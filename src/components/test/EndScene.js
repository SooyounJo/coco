...
const EndSceneV4 = dynamic(() => import('@/components/test/endscene/V4'), { ssr: false });
  ...
  return (
    <div className="fixed inset-0">
      <div className="fixed top-3 left-0 right-0 z-[40] flex justify-center gap-2">
        ...
        <button
          className={`px-3 py-1 rounded-full text-sm ${variant === 'v4' ? 'bg-black/70 text-white' : 'bg-white/80 text-black'} `}
